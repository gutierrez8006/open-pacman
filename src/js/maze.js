...
const MAZE_STR = [
  ...
  '#.####.#####.##.#####.####.#', // 21
  '#.####.#####.##.#####.####.#', // 22
  '#o..##................##..o#', // 23  fila inicio Pacman (13,23) + pellets en (1,23) y (26,23)
  '###.##.##.########.##.##.###', // 24
  '###.##.##.########.##.##.###', // 25
  '#......##....##....##......#', // 26
  '#.##########.##.##########.#', // 27
...
const GHOST_STARTS = [
  { x: 12, y: 14, type: 'emboscador',  release: 2  }, // dentro de la pen
  { x: 13, y: 14, type: 'agresor',     release: 5  }, // dentro de la pen
  { x: 14, y: 14, type: 'flanqueador', release: 10 }, // dentro de la pen
  { x: 15, y: 14, type: 'timido',      release: 15 }, // dentro de la pen
];
